...
project(":html") {
    ...
    dependencies {
        ...
        implementation 'com.github.raeleus.stripe:stripe:1.4.2:sources'
    }
}
```
...
dependencies {
    ...
    implementation 'com.github.raeleus.stripe:freetype:1.4.2'
}
```
...
project(":html") {
    ...
    dependencies {
        ...
        implementation 'com.github.raeleus.stripe:freetype:1.4.2:sources'
    }
}
```
