...
public class StripeMenuBar extends Table implements StripeMenu {
    ...
    private final Array<StripeMenuValue> stripeMenuValues = new Array<StripeMenuValue>();
    private final Stage stage;
    private final WidgetGroup modalGroup;
    private boolean menuActivated;
    private final Array<KeyboardShortcutListener> keyboardShortcutListeners = new Array<KeyboardShortcutListener>();
    private final KeyboardFocusListener keyboardFocusListener = new KeyboardFocusListener();
    private final StripeMenuBarStyle style;
    ...
    private TextButton createItem(String name, int textAlign, Array<StripeMenuValue> stripeMenuValues, KeyboardShortcut keyboardShortcut, EventListener... listeners) {
        final TextButton textButton = new TextButton(name, itemStyle);
        textButton.setProgrammaticChangeEvents(false);
    ...
    protected void setStage(Stage stage) {
        if (getParent() != null) {
            if (stage != null) {
                for (KeyboardShortcutListener listener : keyboardShortcutListeners) {
